...
This repository preserves a OCR (Optical Character Recognition) book scan of Hardiman's early nineteenth
century history of Galway. This project was first started by myself 
(Joe Desbonnet) in 1995. I used a 1990s version of OmniPage OCR software
with a flat bed scanner. Unfortunately the OCR technology of the day 
was not at the same level it is today, so there is still a high number
of OCR errors in the text. If I can re-locate the original scan images I will attempt
to re-run the OCR process with more modern software.
